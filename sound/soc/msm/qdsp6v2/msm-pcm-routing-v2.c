...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/11/21, use ext ec ref from NXP9890*/
				  ...
				  struct snd_ctl_elem_value *ucontrol)
{
	...
	if (voc_set_ext_ec_ref(msm_route_ext_ec_ref, state) == 0) {
		mutex_unlock(&routing_lock);
		snd_soc_dapm_mux_update_power(widget, kcontrol, 1, mux, e);
	} else {
		ret = -EINVAL;
...
static const struct snd_kcontrol_new voc_ext_ec_mux =
	SOC_DAPM_ENUM_EXT("VOC_EXT_EC MUX", msm_route_ext_ec_ref_rx_enum[0],
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/11/29, and FM routing for NXP9890*/
#ifdef CONFIG_SND_SOC_NXP9890
...
/*[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/11/29, and FM routing for NXP9890*/
#ifdef CONFIG_SND_SOC_NXP9890
	{"TERT_MI2S_DL_HL", "Switch", "INTFM_DL_HL"},
