...
/*added to resolve that lcd display error(black...) for rio6 global/tf  2014.03.05*/
	int (*reset_timer) (struct mdss_panel_data *pdata);
/*added end*/
#endif
...
#if defined(CONFIG_TCT_8X26_RIO6)||defined(CONFIG_TCT_8X26_RIO6_TF)
/*added to resolve that lcd display error(black...) for rio6 global/tf  2014.03.05*/
	struct delayed_work reset_panel_timer;
	struct dsi_panel_cmds reset_cmds;
/*added end*/
	struct dsi_panel_cmds dispon_cmds;
	struct dsi_panel_cmds slpin_cmds;
#endif
