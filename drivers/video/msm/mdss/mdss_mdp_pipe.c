...
int mdss_mdp_smp_reserve(struct mdss_mdp_pipe *pipe)
{
	...
	int i;
	int rc = 0, rot_mode = 0;
/*[BUGFIX]ADD BEGIN by fangyou.wang,2014/03/06,PR-588311,Case Number:01456755*/
	int wb_mixer=0;
/*[BUGFIX]ADD END by fangyou.wang,2014/03/06,PR-588311*/
	u32 nlines, format;
	u16 width;
...
/*[BUGFIX]MOD BEGIN by fangyou.wang,2014/03/06,PR-588311,Case Number:01456755*/
//		if (rot_mode) {
		if (rot_mode || wb_mixer) {
/*[BUGFIX]MOD END by fangyou.wang,2014/03/06,PR-588311*/
			num_blks = 1;
		} else {
