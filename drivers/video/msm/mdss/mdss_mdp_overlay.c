				       ...
				       struct mdss_mdp_pipe **ppipe)
{
	...
	if (fmt->is_yuv && !(pipe->flags & MDP_SOURCE_ROTATED_90) &&
       ...
       //[BUGFIX]-DEL-BEGIN by TCTNB.(Liu Jie), 2014/01/17,PR-584789,The video player interface has green lines around when play videos
	//pipe->overfetch_disable = fmt->is_yuv &&
	//		!(pipe->flags & MDP_SOURCE_ROTATED_90);
       //[BUGFIX]-DEL-END by TCTNB.(Liu Jie)
