...
/* [PLATFORM]-Add-BEGIN by TCTNB.YJ, 2014/02/20, for the compatible to all series of rio6 LCD */
#if defined(CONFIG_TCT_8X26_RIO6)||defined(CONFIG_TCT_8X26_RIO6_TF)
#define HX8394A_TDT_RIO6_1ST 		"qcom,mdss_dsi_hx8394_hd_video"
#define NT35521_TRULY_RIO6_2ND 	"qcom,mdss_dsi_nt35521_hd_video_rio6"
#define HX8389B_TDT_RIO6TF_1ST	"qcom,mdss_dsi_hx8389b_qhd_video"
#define HX8389B_TRULY_RIO6TF_2ND	"qcom,mdss_dsi_hx8389b_qhd_video_rio6tf2nd"
int lcd_no_poweric;
static int is_lcd_without_power_ic(char *panel_cfg)
{
	char *panel_name;
	if(NULL == panel_cfg)
		return -1;
	panel_name = panel_cfg + 8;
	printk(">=%s\n", panel_name);
	if(0 == strncmp(panel_name, HX8394A_TDT_RIO6_1ST, strlen(HX8394A_TDT_RIO6_1ST)))
		return 1;
	if(0 == strncmp(panel_name, NT35521_TRULY_RIO6_2ND, strlen(NT35521_TRULY_RIO6_2ND)))
		return 1;
	if(0 == strncmp(panel_name, HX8389B_TDT_RIO6TF_1ST, strlen(HX8389B_TDT_RIO6TF_1ST)))
		return 0;
	if(0 == strncmp(panel_name, HX8389B_TRULY_RIO6TF_2ND, strlen(HX8389B_TRULY_RIO6TF_2ND)))
		return 0;
	return 2;
}
#endif
...
/* [PLATFORM]-Add-BEGIN by TCTNB.YJ, 2014/02/20, for the compatible to all series of rio6 LCD */
#if defined(CONFIG_TCT_8X26_RIO6)||defined(CONFIG_TCT_8X26_RIO6_TF)
	lcd_no_poweric = is_lcd_without_power_ic(panel_name);
	printk(">=%d\n", lcd_no_poweric);
#endif
/* [PLATFORM]-Add-End by TCTNB.YJ */
