...
#define GC0339_SENSOR_NAME "gc0339_sunrise"

DEFINE_MSM_MUTEX(gc0339_sunrise_pop7lte_mut);

static uint8_t sunrise_module = 0;
...
static int32_t gc0339_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	if (1 != rc) {
		pr_err("inappropriate driver for not sunrise module.\n");
		return -1;
	}
	sunrise_module = 1;
...
static struct msm_sensor_ctrl_t gc0339_s_ctrl = {
	...
	.msm_sensor_mutex = &gc0339_sunrise_pop7lte_mut,
...
static const struct of_device_id gc0339_dt_match[] = {
	{.compatible = "sunrise,gc0339_sunrise_pop7lte", .data = &gc0339_s_ctrl},
	{}
};
...
static struct platform_driver gc0339_platform_driver = {
	.driver = {
		.name = "sunrise,gc0339_sunrise_pop7lte",
		.owner = THIS_MODULE,
