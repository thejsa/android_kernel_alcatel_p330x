...
static struct msm_camera_i2c_reg_conf s5k8aay_read_chipid[] = {
	{0xfcfc, 0x0000},
};

#if 0
static struct msm_camera_i2c_reg_conf s5k8aay_start_settings[] = {
	{0x0028, 0x7000},
	{0x002A, 0x040C},
	{0x0F12, 0x0001},
};

static struct msm_camera_i2c_reg_conf s5k8aay_stop_settings[] = {
	{0x0028, 0x7000},
	{0x002A, 0x040C},
	{0x0F12, 0x0000},
};
...
static struct msm_camera_i2c_reg_conf s5k8aay_recommend_settings_0[] = {
    {0xFCFC, 0xD000},//
...
static struct msm_camera_i2c_reg_conf s5k8aay_recommend_settings_1[] = {
    //*************************************/
    // 03.Trap and Patch                  */
    //*************************************/
    // Start T&P part
...
static int32_t msm_s5k8aay_i2c_probe(struct i2c_client *client,
...
static int32_t s5k8aay_platform_probe(struct platform_device *pdev)
{
	int32_t rc;
...
static int __init s5k8aay_init_module(void)
{
	int32_t rc;
	pr_info("%s:%d\n", __func__, __LINE__);
	
	rc = platform_driver_probe(&s5k8aay_platform_driver,
		s5k8aay_platform_probe);
	if (!rc)
		return rc;
...
static void __exit s5k8aay_exit_module(void)
{
	pr_info("%s:%d\n", __func__, __LINE__);
...
int32_t s5k8aay_sensor_config(struct msm_sensor_ctrl_t *s_ctrl,
	void __user *argp)
{
	...
	case CFG_SET_INIT_SETTING:
		...
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
			i2c_write_conf_tbl(
			s_ctrl->sensor_i2c_client, s5k8aay_recommend_settings_0,
			ARRAY_SIZE(s5k8aay_recommend_settings_0),
		...
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
			i2c_write_conf_tbl(
			s_ctrl->sensor_i2c_client, s5k8aay_recommend_settings_1,
			ARRAY_SIZE(s5k8aay_recommend_settings_1),
			MSM_CAMERA_I2C_WORD_DATA);
#endif
		break;
...
//by wangpl, setting for preview
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
			i2c_write_conf_tbl(
			s_ctrl->sensor_i2c_client, s5k8aay_svga_settings,
			ARRAY_SIZE(s5k8aay_svga_settings),
			MSM_CAMERA_I2C_BYTE_DATA);
//#else
//by wangpl, setting for snapshot
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
			i2c_write_conf_tbl(
			s_ctrl->sensor_i2c_client, s5k8aay_uxga_settings,
			ARRAY_SIZE(s5k8aay_uxga_settings),
			MSM_CAMERA_I2C_BYTE_DATA);
#endif
		break;
	case CFG_SET_STOP_STREAM:
		...
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
			i2c_write_conf_tbl(
			s_ctrl->sensor_i2c_client, s5k8aay_stop_settings,
			ARRAY_SIZE(s5k8aay_stop_settings),
			MSM_CAMERA_I2C_BYTE_DATA);
#endif
		break;
...
static int32_t s5k8aay_sensor_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t ret = 0;
	ret= s_ctrl->sensor_i2c_client->i2c_func_tbl->
		    i2c_write_conf_tbl(
		    s_ctrl->sensor_i2c_client, s5k8aay_read_chipid,
		    ARRAY_SIZE(s5k8aay_read_chipid),
		    MSM_CAMERA_I2C_WORD_DATA);
	if (ret < 0){
...
static struct msm_sensor_fn_t s5k8aay_sensor_func_tbl = {
	...
	.sensor_match_id = s5k8aay_sensor_match_id,
};
...
module_init(s5k8aay_init_module);
module_exit(s5k8aay_exit_module);
