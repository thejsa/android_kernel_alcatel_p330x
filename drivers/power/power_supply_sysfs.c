...
// [PLATFORM]-Add by TCTSZ.cuiping.shi, for print log 2014/03/19
...
// [PLATFORM]-Add-END by TCTSZ.cuiping.shi,  2014/03/19
...
static struct device_attribute power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(charge_voltage),//add by rongxiao.deng for engineer mode
	POWER_SUPPLY_ATTR(charge_temp),
	POWER_SUPPLY_ATTR(power_on_voltage),//add end
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.Yubin, 2013/11/28, refer to fr508845(miata), fr521336(rio6) */
	...
	POWER_SUPPLY_ATTR(charger_is_good),
#endif
