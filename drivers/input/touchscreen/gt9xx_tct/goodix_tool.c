 ...
 *        V1.6:new proc name
 *        V1.61 12/10/15 NB.TCL xqj modfied to add update firmeware     
*/ 
#include "gt9xx.h"
...
extern void gtp_reset_guitar(struct goodix_ts_data *ts, int ms);//[BUGFIX]-Add by TCTNB.XQJ, bug 	623533,2014/03/19, For After TP Raw Data test,tp can't be used
...
/*[BUGFIX]-Mod by TCTNB.XQJ, bug 	623533,2014/03/19 For After TP Raw Data test,tp can't be used*/
       //gtp_irq_enable(i2c_get_clientdata(gt_client));

        gtp_reset_guitar(i2c_get_clientdata(gt_client),20);//[BUGFIX]-Add by TCTNB.XQJ, bug 622977,2014/03/19 For After TP Raw Data test,tp can't be used
		#if GTP_ESD_PROTECT
