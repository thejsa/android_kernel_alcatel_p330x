...
/*[PLATFORM]-Add-BEGIN by TCTNB.YuBin, 2014/01/27, refer to case01421546*/
...
static bool floated_charger_enable=true; // [PLATFORM]-Change by TCTSZ.cuiping.shi, for use other way to get carkit charge 2014/03/12
...
// [PLATFORM]-Change by TCTSZ.cuiping.shi, for wait other work, 2014/03/19
...
// [PLATFORM]-Change by TCTSZ.cuiping.shi, for use other way to get carkit charge 2014/03/12
...
/*[PLATFORM]-Add-BEGIN by TCTNB.YuBin, 2013/10/11, Add carkit charger supported, fr523151,523406*/
#if 0//def CONFIG_USB_SUPPORT_CARKIT_CHARGER
// [PLATFORM]-Remove by TCTSZ.cuiping.shi, for  use other way to get carkit charge 2014/03/12
...
static void msm_otg_sm_work(struct work_struct *w)
{
    ...
    //[BUGFIX]-Add-BEGIN by TCTNB.Huaidi.Feng, 2014/02/12, add to fix the USB charger caused race then crash issue PR591408
    if (motg->pm_done)
         pm_runtime_get_sync(otg->phy->dev);
    //[PLATFORM]-Add-END by TCTNB.Huaidi.Feng
	pr_debug("%s work\n", otg_state_string(otg->phy->state));
			...
			case USB_CHG_STATE_DETECTED:
				...
				case USB_SDP_CHARGER:
					...
					mod_timer(&motg->chg_check_timer,
							CHG_RECHECK_DELAY);
/*[PLATFORM]-Add-BEGIN by TCTNB.YuBin, 2013/10/11, Add carkit charger supported, fr523151,523406*/
#ifdef CONFIG_USB_SUPPORT_CARKIT_CHARGER
// [PLATFORM]-Remove by TCTSZ.cuiping.shi, for use other way to get carkit charge 2014/03/12
