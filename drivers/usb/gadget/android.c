					...
					struct usb_composite_dev *cdev)
{
	...
	config->fsg.nluns = 1;
	name[0] = "lun";
	#ifndef FEATURE_TCTNB_MMITEST  //shenghua.gong@tcl.com add start, mini edition disable cdrom function
	if (dev->pdata && dev->pdata->cdrom) {
		...
		config->fsg.nluns++;
		//[BUGFIX]-Add-BEGIN by TCTNB.Xiaoman.Wang,03/25/2014,559855,USB autoinstall
	...
	#endif  //shenghua.gong@tcl add end
