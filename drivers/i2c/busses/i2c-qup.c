...
extern int msg21xx_debug(void);	/*[BUGFIX]-ADD by TCTSZ.WH,03/31/2014,PR-602310*/
extern int msg21xx_fw_upgrade(void);
#endif
static int
...
#if defined(CONFIG_TCT_8X26_RIO4G)
	if ((dev->clk_ctl == 0) || msg21xx_debug() || msg21xx_fw_upgrade()){	/*[BUGFIX]-MOD by TCTSZ.WH,03/31/2014,PR-602310,Change i2c speed when read rawdata*/
							/*[BUGFIX]-MOD by TCTSZ.WH,4/1/2014,PR-602310,Change i2c speed when upgrading fw*/
#else
	if ((dev->clk_ctl == 0)){
#endif
		int fs_div;
