			       ...
			       __u32 init_rcv_wnd)
{
   ...
   //[FEATURE]-Mod-BEGIN by TCTNB.Fuqiang.Song,11/21/2013,546148,
   //[48.11][CDR-CDS-071]TCP Optimizations Advertised Receive
   //window size
   #if defined(CONFIG_TCT_8X26_RIO6_TF) || defined(CONFIG_TCT_8X26_RIO4G_TF)
   if(*window_clamp <6)
      (*window_clamp) = 6;
   #endif
