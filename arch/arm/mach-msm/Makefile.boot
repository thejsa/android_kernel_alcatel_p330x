...
#[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/08/15, Added dt for RIOL project
ifdef CONFIG_TCT_8X26_RIOL
        dtb-$(CONFIG_ARCH_MSM8226)      += msm8926-mtp-riol.dtb
endif
#[PLATFORM]-Add-END by TCTNB.WQF
#[PLATFORM]-Add-BEGIN by TCTNB.WQF, 2013/09/23, Added dt for MIATA project
ifdef CONFIG_TCT_8X26_MIATA
        dtb-$(CONFIG_ARCH_MSM8226)      += msm8926-720p-mtp-miata.dtb
endif
ifdef CONFIG_TCT_8X26_RIO6_TF
        dtb-$(CONFIG_ARCH_MSM8226)      += msm8926-720p-mtp-rio6_tf.dtb
endif
ifdef CONFIG_TCT_8X26_RIO6
        dtb-$(CONFIG_ARCH_MSM8226)      += msm8926-720p-mtp-rio6.dtb
endif
ifdef CONFIG_TCT_8X26_EOS
        dtb-$(CONFIG_ARCH_MSM8226)      += msm8926-720p-mtp-eos.dtb
endif
ifdef CONFIG_TCT_8X26_EOS_CUCC
        dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-720p-mtp-eos_cucc.dtb
endif
ifdef CONFIG_TCT_8X26_RIO4G
        dtb-$(CONFIG_ARCH_MSM8226)      += msm8926-720p-mtp-rio4g.dtb
endif
ifdef CONFIG_TCT_8X26_RIO5_CTCC
        dtb-$(CONFIG_ARCH_MSM8226)      += msm8926-720p-mtp-rio5_ctcc.dtb
endif
ifdef CONFIG_TCT_8X26_RIO4G_TF
        dtb-$(CONFIG_ARCH_MSM8226)      += msm8926-720p-mtp-rio4g_tf.dtb
endif
#[PLATFORM]-Add-END by TCTNB.WQF
