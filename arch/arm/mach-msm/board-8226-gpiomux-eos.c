...
/* [PLATFORM]-ADD-BEGIN by TCTNB.WJ, 2013/12/19, FR-567374, dev for HALL */
...
static struct gpiomux_setting for_gpio1_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_OUT_LOW,
...
static struct msm_gpiomux_config msm8226_for_gpio1_pin_config[] __initdata = {
	{
		.gpio = 1,
		.settings = {
			[GPIOMUX_SUSPENDED] = &for_gpio1_cfg,
			[GPIOMUX_ACTIVE] = &for_gpio1_cfg,
		},
	},
};
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.YuBin, 2013/11/25, refer to case01362220 Enable external ovp */
    msm_gpiomux_install(msm8226_for_gpio1_pin_config,
            ARRAY_SIZE(msm8226_for_gpio1_pin_config));
/* [PLATFORM]-Mod-END by TCTNB.YuBin */
