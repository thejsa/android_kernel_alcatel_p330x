...
//add by xcb for hardware_board_id
...
//end add by xcb for GPIO_BOARD_ID
...
//end add by xcb for hardware_board_id
...
static struct device_attribute msm_soc_attr_hw_version =
	__ATTR(board_id, S_IRUGO, msm_get_hw_version,  NULL); 
   //end add by xcb for hardware_board_id
   //add by xcb for GPIO_BOARD_ID	
