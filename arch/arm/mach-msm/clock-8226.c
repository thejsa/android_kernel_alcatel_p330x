...
static struct clk_freq_tbl ftbl_camss_gp0_1_clk[] = {
	...
	F_MMSS(  19200000,         xo,   1,    0,    0), //add by xiaoyong.wu for 19.2 gp1_clk bug623746
...
/*[FEATURE]-Add-BEGIN by TCTNB.YuBin, 2013/10/18, FR515461, Add NFC function.*/
	/* NFC */
#ifdef CONFIG_TCT_8X26_COMMON
	CLK_LOOKUP("ref_clk",            cxo_d1_pin.c, "2-0028"),
#else
...
/* [PLATFORM]-Add-BEGIN by TCTNB.WPL, 2013/12/06, EOS sub CAM sunny & sinetech s5k8aay, refer to bug565601*/
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6e.qcom,camera"),
/* [PLATFORM]-Add-END by TCTNB.WPL, 2013/11/07 */
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6a.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6c.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "20.qcom,camera"),
/* [PLATFORM]-Add-BEGIN by TCTNB.HJ, 2013/12/13,for i2c compatibility*/
    CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6b.qcom,camera"),
/* [PLATFORM]-Add-BEGIN by TCTNB.HJ, 2013/12/13 */
...
/* [PLATFORM]-Add-BEGIN by TCTNB.HJ, 2013/12/13 */
//Begin add by weicai.long@tcl.com, 2014/1/13.
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "40.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "40.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "78.qcom,camera"), //GC2035 Shinetech
	...
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "44.qcom,camera"), //sunrise GC0339
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "44.qcom,camera"),
//End add by weicai.long@tcl.com, 2014/1/13.
	...
	//*********modify bu pu.li@tcl.com on 2014.4.28*******
	CLK_LOOKUP("ice40_xo",              xo.c, "ice_xo_clk"),
	CLK_LOOKUP("ice40_mmss",              mmss_gp0_clk_src.c, "ice_mmss_clk"),
	CLK_LOOKUP("ice40_camss",              camss_gp0_clk.c, "ice_camss_clk"),
	//*********end of modify**********
};
...
//	clk_prepare_enable(&xo.c);       //add by xiaoyong.wu for 19.2 gp0_clk bug 623746  change the turn on clk option to ice400 driver
	/*
	...
	//add by xiaoyong.wu.sz for 19.2 gp0_clk bug623746
//	clk_set_rate(&mmss_gp0_clk_src.c,  19200000);
//	clk_prepare_enable(&mmss_gp0_clk_src.c);   // change the turn on clk option to ice400 driver

//	clk_prepare_enable(&camss_gp0_clk.c);     // change the turn on clk option to ice400 driver
