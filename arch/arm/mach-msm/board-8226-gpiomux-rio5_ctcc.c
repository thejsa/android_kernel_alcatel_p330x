...
#endif
/*[BUGFIX]- Mod Begin  by TCTNB.XQJ, FR-564638 2013/12/16,tp gpio configure  */
...
#if 0 /*[BUGFIX]- Removed   by TCTNB.XQJ, FR-564638 2013/12/16,tp gpio configure  */
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.YuBin, 2013/11/25, refer to case01362220 Enable external ovp */
static struct gpiomux_setting for_gpio5_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_OUT_LOW,
...
static struct msm_gpiomux_config msm8226_for_gpio5_pin_config[] __initdata = {
	{
		.gpio = 5,
		.settings = {
			[GPIOMUX_SUSPENDED] = &for_gpio5_cfg,
			[GPIOMUX_ACTIVE] = &for_gpio5_cfg,
		},
	},
};
	...
	if (of_board_is_qrd())
		msm_gpiomux_install(msm_qrd_goodix_configs,
             ...
             msm_gpiomux_install(msm_goodix_configs,
                   ARRAY_SIZE(msm_goodix_configs));/*[BUGFIX]- Mod Begin  by TCTNB.XQJ, FR-564638 2013/12/16,tp gpio configure  */
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.YuBin, 2013/11/25, refer to case01362220 Enable external ovp */
    msm_gpiomux_install(msm8226_for_gpio5_pin_config,
            ARRAY_SIZE(msm8226_for_gpio5_pin_config));
/* [PLATFORM]-Mod-END by TCTNB.YuBin */
