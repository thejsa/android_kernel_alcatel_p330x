...
/* [PLATFORM]-Mod-BEGIN by TCTNB.Yubin, 2013/12/02, Changed max current to 1000mA as HW suggestion */
#if 0//def CONFIG_TCT_8X26_COMMON //  [PLATFORM]-change  by TCTSZ.cuiping.shi for change chg current
 ...
 * @pm_done: Indicates whether USB is PM resumed  @huaidi.feng fix for bug591408 to fix the usb charger race
 */
struct msm_otg {
	struct usb_phy phy;
...
/*[PLATFORM]-Add-BEGIN by TCTNB.YuBin, 2013/10/11, Add carkit charger supported, fr523151,523406*/
	...
	//struct delayed_work carkit_detect; // [PLATFORM]-Remove by TCTSZ.cuiping.shi, for use other way to get carkit charge 2014/03/12
#endif
