...
enum qpnp_vadc_channels {
	...
	TCT_BOARD_INFO = 254,/* [PLATFORM]-ADD by TCTNB.YuBin, 2013/12/20, FR-552166, dev for board id */
	ALL_OFF = 255,
	ADC_MAX_NUM,
};
...
/* [PLATFORM]-ADD-BEGIN by TCTNB.WJ, 2013/12/21, CR-534823 & 575135, dev for Haptic */
#if defined(CONFIG_TCT_8X26_RIO6)||defined(CONFIG_TCT_8X26_RIO6_TF)||defined(CONFIG_TCT_8X26_EOS)
